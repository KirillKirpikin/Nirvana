(() => {
    ...
    function initSliders() {
        if (document.querySelector(".banket-block__slider")) new core(".banket-block__slider", {
            ...
            navigation: {
                prevEl: ".banket-block__button-prev",
                nextEl: ".banket-block__button-next"
            },
            on: {}
        });
    }
    ...
    ibg();
    const script_link = document.querySelectorAll(".header__item");
    document.querySelector(".header__list"), document.querySelectorAll(".header__link");
    script_link[6].addEventListener("click", (() => {
        script_link[6].classList.toggle("header__active_nav");
    }));
    window["FLS"] = true;
    isWebp();
})();